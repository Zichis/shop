<x-dashboard-layout>
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-16 mx-auto">
            <form action="{{ route('customer.orders.update', ['order' => $order->id]) }}" method="post">
                <div class="lg:w-4/5 flex flex-wrap">
                    ...
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div class="mt-5">
                            <a href="{{ route('customer.cart.index') }}" class="py-2 px-4 font-bold border-1 bg-gray-700 text-gray-100 hover:bg-gray-800 hover:text-white">
